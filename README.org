...
#+begin_src sh
export ROW_IMPL_DIR=/path/of/your/choice/vectoradd-constellation/build/install/vectoradd-constellation
#+end_src

Otherwise:

#+begin_src sh
export ROW_IMPL_DIR=/path/of/your/choice/vectoradd-constellation
cd $ROW_IMPL_DIR
#+end_src
